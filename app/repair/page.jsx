...
import { Monitor, BatteryCharging, Power, Flame, AlertTriangle, Play } from "lucide-react"
...
const issueOptions = [
  { label: "Slow Performance", icon: <Monitor /> },
  { label: "Battery / Power Issues", icon: <BatteryCharging /> },
  { label: "Won’t Turn On", icon: <Power /> },
  { label: "Overheating", icon: <Flame /> },
  { label: "Error Messages", icon: <AlertTriangle /> },
  { label: "Cracked Screen", icon: <Play /> },
]
  ...
  return (
    ...
    <div className="w-full px-0 md:px-8 py-10">
        ...
        >
          <h1 className="text-4xl font-semibold text-center mb-6">Need a Quick Fix? <br /> We’ve Got You Covered</h1>
      ...
      <div className="max-w-3xl px-2 mx-auto">
        <h1 className="text-3xl sm:text-4xl font-semibold text-center mb-3">Send us a message</h1>
        <p className="text-sm text-center text-gray-600 mb-10 px-4">
          Lorem ipsum dolor sit amet consectetur. Et nunc rhoncus dictum urna. Viverra enim aute aute viverra habitant.
          Auctor tempor nunc placerat libero.
        </p>
        ...
        <form className="space-y-6 bg-white px-4 sm:px-6 py-6 rounded-2xl ">
          {[
            ...
            { id: "deviceBrand", label: "Device Brand & Model", placeholder: "HP, Dell, etc." },
            {
              id: "issueType",
              label: "Issue Type",
              placeholder: "Slow Performance, Screen Broken, Not Turning On, Virus, Overheating, etc.",
            },
          ...
          <div className="space-y-2 border-dashed border border-gray-300 rounded-2xl p-4">
            <label className="p-2 mb-2 block font-medium">Upload Photos (optional)</label>
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-col gap-2">
              {["phone", "email", "whatsapp"].map((method) => (
                <label
                  key={method}
                  className="flex items-center space-x-2 border px-3 py-2 border-gray-200 rounded-2xl"
                >
                  <input
                    type="radio"
                    name="contactMethod"
      ...
      {issueOptions.map(({ label, icon }) => {
        ...
        return (
          <button
            ...
            className={`w-36 h-36 flex flex-col items-center justify-center rounded-2xl border border-gray-200`
            }
          >
