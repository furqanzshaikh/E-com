...
const TimeUnitBox = ({ value, label }) => {
  return (
    <div className="bg-white text-black rounded-xl p-3 sm:p-4 w-20 h-20 sm:w-24 sm:h-24 flex flex-col items-center justify-center">
...
const TimerSection = () => {
  ...
  return (
    <div
      className="relative w-full overflow-hidden rounded-xl text-white mt-12 bg-cover bg-center"
